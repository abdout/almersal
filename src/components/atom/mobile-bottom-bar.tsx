...
export function MobileBottomBar() {
  ...
  // Detect scroll as soon as user starts scrolling
  useEffect(() => {
    const handleScroll = () => {
      ...
      <AnimatePresence>
        {hasScrolled && (
          <motion.div
            ...
            className="absolute bottom-[8px] left-4 right-[88px] flex gap-2 pointer-events-auto"
          >
            {/* Yellow Button - Book Now (same as hero) */}
            <button
              className="flex-1 flex items-center justify-center gap-1.5 px-3 py-2.5 rounded-md font-bold text-xs shadow-lg active:scale-95 transition-transform"
